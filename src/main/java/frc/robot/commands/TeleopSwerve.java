...
public class TeleopSwerve extends CommandBase {    
    ...
    public TeleopSwerve(Drivetrain s_Swerve, DoubleSupplier translationSup, DoubleSupplier strafeSup, DoubleSupplier rotationSup, BooleanSupplier robotCentricSup) {
