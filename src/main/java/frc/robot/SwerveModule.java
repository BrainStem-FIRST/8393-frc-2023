...
public class SwerveModule {
    ...
    private void setSpeed(SwerveModuleState desiredState, boolean isOpenLoop){
        if(isOpenLoop){
            double percentOutput = desiredState.speedMetersPerSecond * DrivetrainConstants.drivetrainLimit / DrivetrainConstants.maxSpeed;
            mDriveMotor.set(ControlMode.PercentOutput, percentOutput);
        }
        else {
            double velocity = DrivetrainConstants.drivetrainLimit * Conversions.MPSToFalcon(desiredState.speedMetersPerSecond, DrivetrainConstants.wheelCircumference, DrivetrainConstants.driveGearRatio);
